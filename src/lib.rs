...
//! - **PDF** — Export drawings to PDF 1.4 (pure Rust, no extra dependencies)
...
//! | [`io`]        | Readers and writers for DXF, DWG, SVG, and PDF |
//! | [`io::svg`]   | [`SvgWriter`] — export drawings to SVG format |
//! | [`io::pdf`]   | [`PdfWriter`] — export drawings to PDF 1.4 format |
